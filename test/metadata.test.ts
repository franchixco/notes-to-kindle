...
describe('identity metadata (0.1.5)', () => {
	it('manifest.json declares the notes-to-kindle identity for 0.1.5', () => {
	...
	it('versions.json preserves release history and adds 0.1.5', () => {
